...
int nbo = 1000;    /// number of particles
...
double timestep = 0.00002; /// viscosity is in Pa.sec so this is seconds. 60 fps means 1sec simulated = 1.8sec realtime
...
double hormone1IntroTime = 0.001;
