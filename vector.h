...
{
public:
    double xx, yy; /// x and y components of the vector
    ...
    vector2D operator+(const vector2D& v) /// pointer used to pass vector by reference, function automatiically derefernce the address?
    {
    ...
    friend vector2D operator*(vector2D vec, const double k)
    {
    ...
    vector2D operator/(double const k)
    {
