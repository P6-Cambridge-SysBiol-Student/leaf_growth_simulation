/// had to edit this file a lot, remove unnecessary semi colons, rename some variable (_logb to logb)
/// this file contains the delaunay tesselation code that can be called in main.cc using the BuildTriangleIndexList
/// which is then used by some openGL code to draw triangles between points

#include <float.h>     // Otherwise you may need these header files
#include <math.h>
#include <stdlib.h>
#include <string.h>
#define WORD  unsigned long   /// this is defined in 2 placed, here and polish.h (tidy later)
